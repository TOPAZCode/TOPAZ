...
!                                        4pi*alpha/2/sw2              (4pi*alpha_s)
        SqMatDip = SqMatDip * 1d0/2d0/3d0* 0.2063277518095031333d0  *  (1.633628179866692484d0)
            ...
            Dipole3 = 3.26725635973d0 * SqMatDip * 1d0/x*( 2d0/(2d0-z-x) -1d0-z ) /(Mom(1:4,i).dot.Mom(1:4,j))/2d0  * DipColorCorr !  CS f-i dipole for qg
...
! print *, "check", MomT(1:4,i).dot.MomT(1:4,i)
...
!                                        4pi*alpha/2/sw2              (4pi*alpha_s)
        SqMatDip = SqMatDip * 1d0/2d0/3d0* 0.2063277518095031333d0  *  (1.633628179866692484d0)
            ...
            DipColorCorr = +2d0/3d0
            Dipole5 = 3.26725635973d0 * SqMatDip * 1d0/x*( 2d0/(2d0-z-x) -Ria*(1d0+x) - x*mt**2/(Mom(1:4,i).dot.Mom(1:4,j)) &
                                                        - mt**2/2d0*(1d0-x)**2/(Mom(1:4,i).dot.Mom(1:4,j)) )/(Mom(1:4,i).dot.Mom(1:4,j))/2d0 * DipColorCorr !  CS i-f dipole for qg
...
!                                        4pi*alpha/2/sw2              (4pi*alpha_s)
        SqMatDip = SqMatDip * 1d0/2d0/3d0* 0.2063277518095031333d0  *  (1.633628179866692484d0)
            ...
            DipColorCorr = -6d0
            Dipole6 = 3.26725635973d0 * SqMatDip * 1d0/x*( 2d0/(2d0-z-x) -Ria*(1d0+x) - x*mt**2/(Mom(1:4,i).dot.Mom(1:4,j)) &
                                                        - mt**2/2d0*(1d0-x)**2/(Mom(1:4,i).dot.Mom(1:4,j)) )/(Mom(1:4,i).dot.Mom(1:4,j))/2d0 * DipColorCorr !  CS i-f dipole for qg
...
14 continue
        ...
        Dipole = Dipole1 + Dipole2 + Dipole3 + Dipole4 + Dipole5 + Dipole6
