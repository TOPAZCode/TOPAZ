...
C  
C FOR PROCESS : t -> b w+ u u~  
C  
C Crossing   1 is t b~ -> w+ u u~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION T_BWPUUB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          T_BWPUUB =T_BWPUUB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
