...
C  
C FOR PROCESS : t -> b w+ b b~  
C  
C Crossing   1 is t b~ -> w+ b b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION T_BWPBBB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,1   ),W(1,6   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,7   ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,1   ),W(1,3   ),GWF ,BMASS   ,ZERO    ,W(1,8   ))    
      CALL JIOXXX(W(1,8   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,9   ),GG ,AMP(2   ))             
      CALL JIOXXX(W(1,8   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,5   ),W(1,2   ),W(1,10  ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,4   ),W(1,3   ),GWF ,TMASS   ,TWIDTH  ,W(1,11  ))    
      CALL JIOXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,1   ),W(1,11  ),W(1,12  ),GG ,AMP(4   ))             
      JAMP(   1) = -AMP(   1)-AMP(   2)
      JAMP(   2) = +AMP(   3)+AMP(   4)
      T_BWPBBB = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          T_BWPBBB =T_BWPBBB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
