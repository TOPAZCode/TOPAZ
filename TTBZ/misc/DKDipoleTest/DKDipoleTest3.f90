...
use modMisc
implicit none
real(8) :: Mom(1:4,1:5),MomT(1:4,1:4),pbDpg,ptDpg,ptDpb,omz,rsq,z,y
real(8) :: mt=172d0,SingDepth,MadGraph_tree,MadGraph_tree2,Dipole2,Dipole,mw=80.419d0
integer :: Pcol1,Pcol2,Steps,i,hel1,hel2,hel3,hel4,hel5
complex(8) :: Ampl1,Ampl2,SqMat
...
!      Steps = 10
     Mom(1:4,1)= (/mt,0d0,0d0,0d0/)
      ...
      do i=1,1
          print *,i
!           call gensing(2,mt,(/mw,0d0/),Mom(1:4,2:3),Pcol1,Pcol2,SingDepth,Steps)
          call genps(3,mt,(/0.8d0,0.2d0,0.4d0,0.2d0,0.2d0/),(/mw,0d0,0d0/),Mom(1:4,2:4),SingDepth)
        ...
        enddo
        enddo
!                                        4pi*alpha/2/sw2              4pi*alpha_s         Nc(glu)
