...
!       print *, i
!                do k=1,6
!                write(*,"(A,F10.5,A,F10.5,A, F10.5,A,F10.5,A,F10.5,A,F10.5,A, F10.5,A,F10.5,A, F10.5,A,F10.5,A, F10.5,A,F10.5,A )")  &
!                          "{",dreal(work(k,1)),"+I*(",dimag(work(k,1)),"),",  &
!                              dreal(work(k,2)),"+I*(",dimag(work(k,2)),"),",  &
!                              dreal(work(k,3)),"+I*(",dimag(work(k,3)),"),",  &
!                              dreal(work(k,4)),"+I*(",dimag(work(k,4)),"),",  &
!                              dreal(work(k,5)),"+I*(",dimag(work(k,5)),"),",  &
!                              dreal(work(k,6)),"+I*(",dimag(work(k,6)),")},"
!                enddo
!                print *, ""
!
!             if (i.eq.4) then
!                   temp(1:6) = work(1:6,4)
!                   work(1:6,4) = work(1:6,6)
!                   work(1:6,6) = temp(1:6)
!                print *, "X"
!                do k=1,6
!                write(*,"(A,F10.5,A,F10.5,A, F10.5,A,F10.5,A,F10.5,A,F10.5,A, F10.5,A,F10.5,A, F10.5,A,F10.5,A, F10.5,A,F10.5,A )")  &
...
!                print *, ""
!                write(*,"(A,F10.5,A,F10.5,A, F10.5,A,F10.5,A,F10.5,A,F10.5,A, F10.5,A,F10.5,A, F10.5,A,F10.5,A, F10.5,A,F10.5,A )")  &
!                          "{",dreal(work(1,7)),"+I*(",dimag(work(1,7)),"),",  &
!                              dreal(work(2,7)),"+I*(",dimag(work(2,7)),"),",  &
!                              dreal(work(3,7)),"+I*(",dimag(work(3,7)),"),",  &
!                              dreal(work(4,7)),"+I*(",dimag(work(4,7)),"),",  &
!                              dreal(work(5,7)),"+I*(",dimag(work(5,7)),"),",  &
!                              dreal(work(6,7)),"+I*(",dimag(work(6,7)),")},"
