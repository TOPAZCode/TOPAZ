...
C  
C FOR PROCESS : w+ -> u d~ g  
C  
C Crossing   1 is w+ u~ -> d~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      DATA (NHEL(IHEL,  9),IHEL=1,4) /  0, -1, -1, -1/
      DATA (NHEL(IHEL, 10),IHEL=1,4) /  0, -1, -1,  1/
      DATA (NHEL(IHEL, 11),IHEL=1,4) /  0, -1,  1, -1/
      DATA (NHEL(IHEL, 12),IHEL=1,4) /  0, -1,  1,  1/
      DATA (NHEL(IHEL, 13),IHEL=1,4) /  0,  1, -1, -1/
      DATA (NHEL(IHEL, 14),IHEL=1,4) /  0,  1, -1,  1/
      DATA (NHEL(IHEL, 15),IHEL=1,4) /  0,  1,  1, -1/
      DATA (NHEL(IHEL, 16),IHEL=1,4) /  0,  1,  1,  1/
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION WP_UDBG(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,5   ),W(1,2   ),W(1,4   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,2   ),W(1,1   ),GWF ,ZERO    ,ZERO    ,W(1,6   ))    
      CALL IOVXXX(W(1,3   ),W(1,6   ),W(1,4   ),GG ,AMP(2   ))             
      JAMP(   1) = -AMP(   1)-AMP(   2)
      WP_UDBG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          WP_UDBG =WP_UDBG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
