...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION WP_UDB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,3   ),W(1,2   ),W(1,1   ),GWF ,AMP(1   ))            
      JAMP(   1) = -AMP(   1)
      WP_UDB = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          WP_UDB =WP_UDB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
