...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION DDB_TTBZ(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,5   ),GZD ,ZERO    ,ZERO    ,W(1,7   ))    
      CALL IOVXXX(W(1,7   ),W(1,2   ),W(1,6   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,2   ),W(1,5   ),GZD ,ZERO    ,ZERO    ,W(1,8   ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          DDB_TTBZ =DDB_TTBZ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
