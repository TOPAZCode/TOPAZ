...
C  
C FOR PROCESS : t -> b w+ a g  
C  
C Crossing   1 is t b~ -> w+ a g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION T_BWPAG(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      ...
      PARAMETER (NGRAPHS=   6,NEIGEN=  1,NEXTERNAL=5)   
...
C ----------
      ...
      CALL FVOXXX(W(1,6   ),W(1,4   ),GAU ,TMASS   ,TWIDTH  ,W(1,7   ))    
      CALL IOVXXX(W(1,1   ),W(1,7   ),W(1,5   ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,1   ),W(1,4   ),GAU ,TMASS   ,TWIDTH  ,W(1,8   ))    
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,8   ),W(1,9   ),W(1,3   ),GWF ,AMP(2   ))            
      CALL IOVXXX(W(1,8   ),W(1,6   ),W(1,5   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,2   ),W(1,4   ),GAD ,BMASS   ,ZERO    ,W(1,10  ))    
      CALL FVIXXX(W(1,1   ),W(1,5   ),GG ,TMASS   ,TWIDTH  ,W(1,11  ))     
      CALL IOVXXX(W(1,11  ),W(1,10  ),W(1,3   ),GWF ,AMP(4   ))            
      CALL FVIXXX(W(1,1   ),W(1,3   ),GWF ,BMASS   ,ZERO    ,W(1,12  ))    
      CALL FVIXXX(W(1,12  ),W(1,4   ),GAD ,BMASS   ,ZERO    ,W(1,13  ))    
      CALL IOVXXX(W(1,13  ),W(1,2   ),W(1,5   ),GG ,AMP(5   ))             
      CALL IOVXXX(W(1,12  ),W(1,10  ),W(1,5   ),GG ,AMP(6   ))             
     ...
     &             +AMP(   6)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          T_BWPAG =T_BWPAG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
