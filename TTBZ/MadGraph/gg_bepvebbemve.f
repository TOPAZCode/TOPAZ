      SUBROUTINE SGG_BEPVEBBEMVE(P1,ANS)
C
...
C
C FOR PROCESS : g g -> b e+ ve b~ e- ve~
C
C Crossing   1 is g g -> b e+ ve b~ e- ve~
      IMPLICIT NONE
C
C CONSTANTS
C
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=GG_BEPVEBBEMVE(P ,NHEL(1,IHEL),JC(1))
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION GG_BEPVEBBEMVE(P,NHEL,IC)
C
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,8   ),W(1,7   ),GWF ,WMASS   ,WWIDTH  ,W(1,10  ))
      CALL FVOXXX(W(1,3   ),W(1,9   ),GWF ,TMASS   ,TWIDTH  ,W(1,11  ))
      CALL FVIXXX(W(1,6   ),W(1,10  ),GWF ,TMASS   ,TWIDTH  ,W(1,12  ))
      CALL FVOXXX(W(1,11  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,13  ))
      CALL IOVXXX(W(1,12  ),W(1,13  ),W(1,1   ),GG ,AMP(1   ))

      CALL FVOXXX(W(1,11  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,14  ))
      CALL IOVXXX(W(1,12  ),W(1,14  ),W(1,2   ),GG ,AMP(2   ))
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,15  ))
      CALL FVOXXX(W(1,11  ),W(1,15  ),GG ,TMASS   ,TWIDTH  ,W(1,16  ))
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,10  ),GWF ,AMP(3   ))
      JAMP(   1) = +AMP(   1)-AMP(   3)
      JAMP(   2) = +AMP(   2)+AMP(   3)
      GG_BEPVEBBEMVE = 0.D0
      DO I = 1, NCOLOR
          ...
          ENDDO
          GG_BEPVEBBEMVE =GG_BEPVEBBEMVE+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
