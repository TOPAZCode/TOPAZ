...
C  
C FOR PROCESS : d d~ -> t t~ g z  
C  
C Crossing   1 is d d~ -> t t~ g z  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=DDB_TTBGZ(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION DDB_TTBGZ(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,6   ),GZD ,ZERO    ,ZERO    ,W(1,8   ))    
      ...
      CALL FVOXXX(W(1,2   ),W(1,6   ),GZD ,ZERO    ,ZERO    ,W(1,11  ))    
      ...
      CALL FVIXXX(W(1,10  ),W(1,6   ),GZD ,ZERO    ,ZERO    ,W(1,15  ))    
      ...
      CALL FVOXXX(W(1,16  ),W(1,6   ),GZD ,ZERO    ,ZERO    ,W(1,19  ))    
     ...
     &             -AMP(  21)-AMP(  22)+AMP(  23)+AMP(  24)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          DDB_TTBGZ =DDB_TTBGZ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
