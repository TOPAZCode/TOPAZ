...
C  
C FOR PROCESS : u~ g -> t t~ u~ z  
C  
C Crossing   1 is u~ g -> t t~ u~ z  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=UBG_TTBUBZ(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION UBG_TTBUBZ(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,9   ),W(1,1   ),W(1,6   ),GZU ,AMP(1   ))            
      ...
      CALL IOVXXX(W(1,5   ),W(1,14  ),W(1,6   ),GZU ,AMP(4   ))            
      ...
      CALL FVOXXX(W(1,1   ),W(1,6   ),GZU ,ZERO    ,ZERO    ,W(1,17  ))    
      ...
      CALL FVIXXX(W(1,5   ),W(1,6   ),GZU ,ZERO    ,ZERO    ,W(1,20  ))    
      ...
      CALL FVIXXX(W(1,25  ),W(1,6   ),GZU ,ZERO    ,ZERO    ,W(1,28  ))    
     ...
     &             -AMP(  11)+AMP(  12)+AMP(  13)-AMP(  14)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          UBG_TTBUBZ =UBG_TTBUBZ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
