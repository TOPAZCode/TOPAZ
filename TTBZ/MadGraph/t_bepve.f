...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION T_BEPVE(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,1   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,5   ))    
      CALL IOVXXX(W(1,3   ),W(1,4   ),W(1,5   ),GWF ,AMP(1   ))            
      JAMP(   1) = +AMP(   1)
      T_BEPVE = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          T_BEPVE =T_BEPVE+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
