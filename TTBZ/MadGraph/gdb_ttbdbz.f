...
C  
C FOR PROCESS : g d~ -> t t~ d~ z  
C  
C Crossing   1 is g d~ -> t t~ d~ z  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=GDB_TTBDBZ(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION GDB_TTBDBZ(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,6   ),GZD ,ZERO    ,ZERO    ,W(1,8   ))    
      ...
      CALL FVIXXX(W(1,5   ),W(1,6   ),GZD ,ZERO    ,ZERO    ,W(1,14  ))    
      ...
      CALL IOVXXX(W(1,18  ),W(1,2   ),W(1,6   ),GZD ,AMP(6   ))            
      ...
      CALL IOVXXX(W(1,5   ),W(1,20  ),W(1,6   ),GZD ,AMP(9   ))            
      ...
      CALL FVIXXX(W(1,23  ),W(1,6   ),GZD ,ZERO    ,ZERO    ,W(1,26  ))    
      ...
      CALL IOVXXX(W(1,5   ),W(1,32  ),W(1,6   ),GZD ,AMP(23  ))            
      CALL IOVXXX(W(1,29  ),W(1,30  ),W(1,6   ),GZD ,AMP(24  ))            
     ...
     &             -AMP(  16)+AMP(  17)+AMP(  18)-AMP(  19)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          GDB_TTBDBZ =GDB_TTBDBZ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
