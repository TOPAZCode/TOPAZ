...
C  
C FOR PROCESS : t -> b w+ a  
C  
C Crossing   1 is t b~ -> w+ a  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION T_BWPA(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          T_BWPA =T_BWPA+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
