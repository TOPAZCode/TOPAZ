...
C  
C FOR PROCESS : u u~ -> t t~ z  
C  
C Crossing   1 is u u~ -> t t~ z  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION UUB_TTBZ(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,5   ),GZU ,ZERO    ,ZERO    ,W(1,7   ))    
      CALL IOVXXX(W(1,7   ),W(1,2   ),W(1,6   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,2   ),W(1,5   ),GZU ,ZERO    ,ZERO    ,W(1,8   ))    
      ...
      CALL IOVXXX(W(1,10  ),W(1,3   ),W(1,5   ),GZU ,AMP(3   ))            
      CALL FVOXXX(W(1,3   ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,11  ))     
      CALL IOVXXX(W(1,4   ),W(1,11  ),W(1,5   ),GZU ,AMP(4   ))            
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          UUB_TTBZ =UUB_TTBZ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
