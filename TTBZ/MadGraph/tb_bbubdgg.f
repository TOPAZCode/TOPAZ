...
C
C FOR PROCESS : t~ -> b~ u~ d g g
C
C Crossing   1 is t~ b -> u~ d g g
      IMPLICIT NONE
C
C CONSTANTS
C
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=TB_BBUBDGG(P ,NHEL(1,IHEL),JC(1))
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION TB_BBUBDGG(P,NHEL,IC)
C
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,6   ),GG ,TMASS   ,TWIDTH  ,W(1,8   ))
      CALL FVIXXX(W(1,2   ),W(1,7   ),GWF ,TMASS   ,TWIDTH  ,W(1,9   ))
      CALL IOVXXX(W(1,9   ),W(1,8   ),W(1,5   ),GG ,AMP(1   ))
      CALL FVOXXX(W(1,1   ),W(1,5   ),GG ,TMASS   ,TWIDTH  ,W(1,10  ))
      CALL FVIXXX(W(1,2   ),W(1,6   ),GG ,BMASS   ,ZERO    ,W(1,11  ))
      CALL IOVXXX(W(1,11  ),W(1,10  ),W(1,7   ),GWF ,AMP(2   ))
      CALL FVIXXX(W(1,3   ),W(1,6   ),GG ,ZERO    ,ZERO    ,W(1,12  ))
      CALL JIOXXX(W(1,2   ),W(1,10  ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))
      ...
      CALL IOVXXX(W(1,9   ),W(1,1   ),W(1,15  ),GG ,AMP(5   ))
      CALL FVOXXX(W(1,10  ),W(1,6   ),GG ,TMASS   ,TWIDTH  ,W(1,16  ))
      CALL IOVXXX(W(1,2   ),W(1,16  ),W(1,7   ),GWF ,AMP(6   ))
      CALL FVIXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,17  ))
      CALL IOVXXX(W(1,17  ),W(1,8   ),W(1,7   ),GWF ,AMP(7   ))
      CALL FVOXXX(W(1,1   ),W(1,7   ),GWF ,BMASS   ,ZERO    ,W(1,18  ))
      CALL IOVXXX(W(1,11  ),W(1,18  ),W(1,5   ),GG ,AMP(8   ))
      CALL JIOXXX(W(1,17  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,19  ))
      CALL IOVXXX(W(1,12  ),W(1,4   ),W(1,19  ),GWF ,AMP(9   ))
      CALL IOVXXX(W(1,3   ),W(1,14  ),W(1,19  ),GWF ,AMP(10  ))
      CALL IOVXXX(W(1,2   ),W(1,18  ),W(1,15  ),GG ,AMP(11  ))
      CALL FVIXXX(W(1,17  ),W(1,6   ),GG ,BMASS   ,ZERO    ,W(1,20  ))
      CALL IOVXXX(W(1,20  ),W(1,1   ),W(1,7   ),GWF ,AMP(12  ))
      CALL FVIXXX(W(1,3   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,21  ))
      CALL JIOXXX(W(1,2   ),W(1,8   ),GWF ,WMASS   ,WWIDTH  ,W(1,22  ))
      CALL IOVXXX(W(1,21  ),W(1,4   ),W(1,22  ),GWF ,AMP(13  ))
      CALL JIOXXX(W(1,11  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,23  ))
      CALL IOVXXX(W(1,21  ),W(1,4   ),W(1,23  ),GWF ,AMP(14  ))
      CALL JIOXXX(W(1,2   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,24  ))
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          TB_BBUBDGG =TB_BBUBDGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
