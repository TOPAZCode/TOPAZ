...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION GU_TTBU(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          GU_TTBU =GU_TTBU+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
