...
C  
C FOR PROCESS : d g -> t t~ d z  
C  
C Crossing   1 is d g -> t t~ d z  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION DG_TTBDZ(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,1   ),W(1,9   ),W(1,6   ),GZD ,AMP(1   ))            
      ...
      CALL FVIXXX(W(1,4   ),W(1,6   ),GZU ,TMASS   ,TWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,13  ),W(1,7   ),W(1,10  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,1   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,14  ),W(1,5   ),W(1,6   ),GZD ,AMP(4   ))            
      CALL FVOXXX(W(1,7   ),W(1,6   ),GZU ,TMASS   ,TWIDTH  ,W(1,15  ))    
      CALL IOVXXX(W(1,4   ),W(1,15  ),W(1,10  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,4   ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,16  ))     
      CALL FVIXXX(W(1,1   ),W(1,6   ),GZD ,ZERO    ,ZERO    ,W(1,17  ))    
      ...
      CALL FVOXXX(W(1,5   ),W(1,6   ),GZD ,ZERO    ,ZERO    ,W(1,20  ))    
      CALL IOVXXX(W(1,1   ),W(1,20  ),W(1,18  ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,16  ),W(1,6   ),GZU ,TMASS   ,TWIDTH  ,W(1,21  ))    
      ...
      CALL FVOXXX(W(1,25  ),W(1,6   ),GZD ,ZERO    ,ZERO    ,W(1,28  ))    
      ...
      CALL IOVXXX(W(1,32  ),W(1,5   ),W(1,6   ),GZD ,AMP(23  ))            
      CALL IOVXXX(W(1,30  ),W(1,29  ),W(1,6   ),GZD ,AMP(24  ))            
     ...
     &             +AMP(  11)-AMP(  12)-AMP(  13)+AMP(  14)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          DG_TTBDZ =DG_TTBDZ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
