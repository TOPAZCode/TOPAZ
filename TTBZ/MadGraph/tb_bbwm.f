...
C  
      ...
      DATA (NHEL(IHEL,  2),IHEL=1,3) / -1, -1,  0/
      DATA (NHEL(IHEL,  3),IHEL=1,3) / -1, -1,  1/
      DATA (NHEL(IHEL,  4),IHEL=1,3) / -1,  1, -1/
      DATA (NHEL(IHEL,  5),IHEL=1,3) / -1,  1,  0/
      DATA (NHEL(IHEL,  6),IHEL=1,3) / -1,  1,  1/
      DATA (NHEL(IHEL,  7),IHEL=1,3) /  1, -1, -1/
      DATA (NHEL(IHEL,  8),IHEL=1,3) /  1, -1,  0/
      DATA (NHEL(IHEL,  9),IHEL=1,3) /  1, -1,  1/
      DATA (NHEL(IHEL, 10),IHEL=1,3) /  1,  1, -1/
      DATA (NHEL(IHEL, 11),IHEL=1,3) /  1,  1,  0/
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION TB_BBWM(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,2   ),W(1,1   ),W(1,3   ),GWF ,AMP(1   ))            
      JAMP(   1) = -AMP(   1)
      TB_BBWM = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          TB_BBWM =TB_BBWM+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
