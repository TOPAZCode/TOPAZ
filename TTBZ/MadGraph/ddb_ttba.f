...
C  
C FOR PROCESS : d d~ -> t t~ a  
C  
C Crossing   1 is d d~ -> t t~ a  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION DDB_TTBA(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,5   ),GAD ,ZERO    ,ZERO    ,W(1,7   ))    
      CALL IOVXXX(W(1,7   ),W(1,2   ),W(1,6   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,2   ),W(1,5   ),GAD ,ZERO    ,ZERO    ,W(1,8   ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          DDB_TTBA =DDB_TTBA+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
