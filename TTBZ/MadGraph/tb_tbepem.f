...
C  
C FOR PROCESS : t~ -> t~ e+ e-  
C  
C Crossing   1 is t~ t -> e+ e-  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=TB_TBEPEM(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION TB_TBEPEM(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IXXXXX(P(0,2   ),TMASS ,NHEL(2   ),-1*IC(2   ),W(1,2   ))       
      CALL IXXXXX(P(0,3   ),ZERO ,NHEL(3   ),-1*IC(3   ),W(1,3   ))        
      CALL OXXXXX(P(0,4   ),ZERO ,NHEL(4   ),+1*IC(4   ),W(1,4   ))        
      CALL JIOXXX(W(1,2   ),W(1,1   ),GAU ,ZERO    ,ZERO    ,W(1,5   ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          TB_TBEPEM =TB_TBEPEM+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
