...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION T_BWP(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,1   ),W(1,2   ),W(1,3   ),GWF ,AMP(1   ))            
      JAMP(   1) = +AMP(   1)
      T_BWP = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          T_BWP =T_BWP+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
