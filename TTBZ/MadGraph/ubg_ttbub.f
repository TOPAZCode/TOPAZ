...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=UBG_TTBUB(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION UBG_TTBUB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,5   ),W(1,1   ),W(1,7   ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,4   ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,8   ))     
      CALL JIOXXX(W(1,5   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      ...
      CALL IOVXXX(W(1,11  ),W(1,1   ),W(1,10  ),GG ,AMP(4   ))             
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          UBG_TTBUB =UBG_TTBUB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
