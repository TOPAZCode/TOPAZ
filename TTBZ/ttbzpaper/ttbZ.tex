...
constrained at the 95\% confidence level to $C_\mathrm{V}^{\mathrm{SM}}=0.24^{+0.39}_{-0.85}$ and $C_\mathrm{A}=-0.60^{+0.14}_{-0.18}$, where the central values are the Standard Model couplings.
...
Figure~\ref{fig:i} also demonstrates good agreement in shape for the top quark $p_{\mathrm{T}}$ distribution between our results (RS) and Fig.~1a in Ref.~\cite{Garzelli:2012bn}.
\begin{figure}[t]
\centering
...
We perform this analysis on the inclusive cross-section reported by CMS, and find relatively weak limits of  $-8 \lesssim \DConeV \lesssim 7$ and $-3 \lesssim \DConeA \lesssim  1$ at NLO. 
This preliminary result motivates an analysis at the $\sqrt{s}=13$ TeV LHC run.
