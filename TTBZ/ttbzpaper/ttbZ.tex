...
constrained to $C_\mathrm{V}=0.24^{+0.36}_{-0.72}$ and $C_\mathrm{A}=-0.60^{+0.09}_{-0.12}$, at the 95.5\% confidence level.
This is an improvement by 22\% and 54\%, respectively, compared to an analysis based on leading-order input alone.
...
A minimal set of dimension-6 operators for top quark production and decay have been categorized in Ref.~\cite{AlcarazMaestre:2012vp,AguilarSaavedra:2008zc,Zhang:2012cd}.
...
In this work we will confine ourselfs to the study of the above vector and axial couplings $C_{1,V/A}$. \
...
However, the common practise of modelling acceptance effects at LO and multiplying with a $K$-factor obtained from a NLO calculation with stable particles,
...
with a calculation that uses the pdf sets from CTEQ6L1~\cite{Pumplin:2002vw} and CTEQ10~\cite{Lai:2010vv} at LO and NLO QCD, respectively. 
We find 
\be
\label{XsecNumCTEQ}
...
\caption{\label{fig:iii} Left: Comparison of transverse momenta of leptons arisiong from the top quark decay (dark) and the $Z$~boson  (light)
...
Fig.~\ref{fig:ii}(left) shows the transverse momemtum of the two lepton system reconstructing the $Z$~boson.
...
\begin{figure}[t]
\centering % \begin{center}/\end{center} takes some additional vertical space
\includegraphics[width=0.45\textwidth]{./LHC_53_Fig17a.pdf}
\hfill
\includegraphics[width=0.45\textwidth]{./LHC_53_Fig17b.pdf}
...
In terms of absolute numbers, this corresponds to a variation of $x.xx...x.xx$ around $\ConeVSM=x.xx$ and $y.yy..y.yy$ around $\ConeASM=z.zz$.
The plots in Fig.~\ref{fig:ix} show the significance with which non-SM $\ttbZ$ couplings can be separated from the SM hypothesis.
...
As metioned before, we assume total uncertainties of $30\%$ at LO and $15\%$ at NLO.
...
increasing the luminsity drastically improves the limits. 
...
We find that with $300\, \invfb$ and LO input, $\DConeV$ is constrained between $-4...3$ and $\DConeA$ between $\pm 0.4$, at the 95\% C.L.
These limits improve with NLO QCD input to $-3...1$ for $\DConeV$ and $-0.2...0.3$ for $\DConeA$.
The latter numbers correspond to xxxxxxx in terms of absolute values.
...
% On the other hand, the value of $\DConeV$ can be as low as -4 or as high as 3. 
Another noticeable feature is that large values of $| \DConeV |$ can conspire 
...
\begin{figure}[t]
\includegraphics[scale=0.507]{LHC_53_LLSign_13LO30.pdf} 
\includegraphics[scale=0.5]{LHC_53_LLSign_13NLO30.pdf} 
\\[2ex]
\includegraphics[scale=0.507]{LHC_53_LLSign_13LO300.pdf} 
\includegraphics[scale=0.5]{LHC_53_LLSign_13NLO300.pdf} 
\\[2ex]
\includegraphics[scale=0.5]{LHC_53_LLSign_13LO3000.pdf} 
...
\begin{figure}[t]
\centering
\includegraphics[scale=0.4]{OPLimitNLO300.pdf} 
\hspace{1cm}
\includegraphics[scale=0.4]{OPLimitNLO3000.pdf} 
...
This situation will change once the high energy LHC delievers its first tens~$\invfb$ of data.
...
% For this we investigate the distribution of the angle between the two leptons from the $Z$~boson decay 
% which is particularly sensitive to variations of the $\ttbZ$-couplings.
We perform the analysis through a binned log-likelihood ratio test which proves advantageous for several reasons.
Firstly, the use of likelihood functions guarantees correct results even for low number of events when, for example, a simple $\chi^2$ analysis would fail.
...
% The interactions of top quarks with other bosons, such as the Higgs or a photon, can also be studied through few changes in our framework.
