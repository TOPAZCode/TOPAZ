...
This approximation is parametric in $\Gamma/m$ and its wide range of validity has been studied in Refs.~\cite{}.
...
For interactions of a $Z$-boson with top quarks the four anomalous couplings, $C_{1/2,V/A}$, remain and Eq.~\ref{L_SM} becomes
\be
\label{L_NP}
...
The couplings can now be written in terms of the SM contribution and deviations due to higher dimensional operators
\be
\label{Cone_NP}
...
Their tree level value vanishes in the SM and appears only at two-loops~\cite{}, $C^\mathrm{SM}_{2,V/A} \sim \mathcal{O}(\alpha_s^y\alpha^y)$.
...
non-renormalizable virtual amplitudes at NLO.
