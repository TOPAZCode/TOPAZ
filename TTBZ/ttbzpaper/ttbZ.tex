...
a significantly lower $K$-factor of $K=1.23$. 
This emphasizes the importance of modelling a realistic final state including all spin correlations.
The ratio of the cross sections with and without cuts defines the acceptance function for which we find
\be
