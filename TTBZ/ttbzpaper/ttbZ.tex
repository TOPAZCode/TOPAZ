...
Having presented our main results in Figs.~\ref{fig:CMS} and Figs.~\ref{fig:viii}, we can use the obtained limits to put constraints on 
possible effects of physics beyond the SM. 
The relevant dimension-6 operators have been presented in Eq.~\ref{EFTOp}.
...
\be
 -31.4 \left(\frac{\Lambda}{1\,\mathrm{TeV}} \right)^2 
 \le  \mathrm{Re} \left[ C^{(3,33)}_{\phi q} - C^{(1,33)}_{\phi q}  \right]   
 \le  42.2 \left(\frac{\Lambda}{1\,\mathrm{TeV}} \right)^2  ,
 \nonumber \\ \\ \nonumber 
...
\be
 -26.8 \left(\frac{\Lambda}{1\,\mathrm{TeV}} \right)^2 
 \le  \mathrm{Re} \left[ C^{(3,33)}_{\phi q} - C^{(1,33)}_{\phi q}  \right]   
 \le  40.0 \left(\frac{\Lambda}{1\,\mathrm{TeV}} \right)^2  ,
 \nonumber \\ \\ \nonumber
...
%  
 ...
 \end{array} \right. .
\ee
A graphical representaion of these limits are given in Fig.~\ref{fig:ix} for $\Lambda=$1~TeV, including the experimental LEP constraints.
...
\caption{\label{fig:ix} Projected constraints on the operators $C^{(33,3)}_{\phi q}$ and $C^{33}_{\phi u}$}
\end{figure}
