...
underestimates the correct result by $\sim 1- A^\mathrm{NLO}/A^\mathrm{LO}=11\%$.
...
\ee
These cross sections are about 14\% smaller at LO and 7\% smaller at NLO QCD than the results obtained with MSTW parton distribution functions. 
The resulting scale uncertainty bands are approximately the same for CTEQ and MSTW.
