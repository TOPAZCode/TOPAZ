...
\centering % \begin{center}/\end{center} takes some additional vertical space
\includegraphics[width=0.49\textwidth]{./LHC_53_Fig01.eps}
\caption{\label{fig:iv} Comparison of an explicit calculation for the non-SM coupling choice $(\delta_V,\delta_A)=(-3.00,-0.3)$ 
and an extrapolation obtained from the fit described in Eq.~\cite{eq:couplfit}. }
\end{figure}
...
\caption{Significance levels for deviations from SM vector and axial couplings $\DConeV$ and $DConeA$,  using 300 $\invfb$ of data at the $\sqrt{s}=13$ TeV LHC. 
