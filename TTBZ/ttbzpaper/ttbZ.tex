...
\begin{figure}[t]
\centering % \begin{center}/\end{center} takes some additional vertical space
\includegraphics[width=0.49\textwidth]{./LHC_53_Fig01and03.eps}
\hfill
\includegraphics[width=0.49\textwidth]{./LHC_53_Fig17e.eps}
...
Right: Comparison of NLO predictions using two different pdf sets (MSTW light, CT10 dark) for the azimuthal opening angle of the two leptons from the $Z$ boson.
The lower panes show the differential $K$-factors.}
\end{figure}
