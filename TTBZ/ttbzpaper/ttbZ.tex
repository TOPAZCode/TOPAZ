...
Numerically, one finds that with $300\, \invfb$ and LO input $\DConeV$ is constrained between $[-4\, ...\, 2.5]$ and $\DConeA$ between $[-0.4\, ...\, 0.4]$, 
...
The limits improve with NLO QCD predictions to $[-3\, ...\, 1.5]$ for $\DConeV$ and $[-0.2\, ...\, 0.3]$ for $\DConeA$.
In terms of absolute values, these intervals correspond to $[-0.5\, ...\, 0.6]$ and $[-0.75\, ...-0.5]$ for vector and axial couplings, respectively.
...
% \hspace{0.5cm}
% \includegraphics[scale=0.43]{OPLimitNLO3000.pdf} 
...
A more appropriate graphical representaion of these limits is given in Fig.~\ref{fig:x} for our NLO results. 
...
We observe that these limits from $\ttbZ$ production at the LHC are well-alligned with the precision limit from $\varepsilon_1$.
