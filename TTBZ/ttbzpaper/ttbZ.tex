...
\hfill
\includegraphics[width=0.49\textwidth]{./LogLikelihoods_NLO.eps}\caption{\label{fig:vii}
...
with $(\DConeV,\DConeA)=(0.8,0.24)$. The left plot shows the separating power using LO input, 
...
An example of two such probability distributions is shown in Fig.~\ref{fig:vii}a and Fig.~\ref{fig:vii}b for LO and NLO QCD, respectively. 
