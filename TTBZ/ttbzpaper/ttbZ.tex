...
only the high energy LHC run allows such a determination for the first time.
...
based on normalization and shape information of the angle between the two leptons from the Z boson decay.
...
and many Standard Model (SM) measurements are competitive with previous determinations, if not even exceeding them.
Furthermore, many minimal extensions of the SM are highly disfavored, pushing the scale of new physics to larger values.
...
The analysis of these processes will allow the direct access of the electroweak top quark couplings, some of which are only indirectly constrained or not constrained at all. 
Progress in this direction has already been made with the measurement of $Q_t$ in $\ttb+\gamma$ production  \cite{Aad:2013uza} {\bf check this}; other prominent possibilities include the measurement of electric and magnetic dipole moments in single top$+\gamma$ production, as well as $y_t$ in the $\ttb+H$ process.
