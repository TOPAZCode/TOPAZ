module modIntDipoles_GGTTBG
use ModTopDecay
implicit none
private

public:: EvalIntDipoles_GGTTBG
...
contains
      ...
      SUBROUTINE EvalIntDipoles_GGTTBG(p,pDK,z,res)
      use modParameters
      use modMisc
      use ModIntDipoles
      implicit none
...
!    Tree_34  = Tree_GG_TTb_34(TreeMom,(/0d0,0d0,m_Top**2,m_Top**2/)) * 0.5d0
    ...
    Tree_ij= Tree_GG_TTb_ij(TreeMom,(/0d0,0d0,m_Top**2,m_Top**2/))
...
!    print *, (Tree_12+Tree_13+Tree_14)/Tree_GG_TTb_00(TreeMom,(/0d0,0d0,m_Top**2,m_Top**2/))  !=-CA
!    print *, (Tree_12+Tree_23+Tree_24)/Tree_GG_TTb_00(TreeMom,(/0d0,0d0,m_Top**2,m_Top**2/))  !=-CA
!    print *, (Tree_14+Tree_24+Tree_34)/Tree_GG_TTb_00(TreeMom,(/0d0,0d0,m_Top**2,m_Top**2/))  !=-CF
!    print *, (Tree_13+Tree_23+Tree_34)/Tree_GG_TTb_00(TreeMom,(/0d0,0d0,m_Top**2,m_Top**2/))  !=-CF
!    stop
...
!    stop
  ...
  END SUBROUTINE
      ...
      FUNCTION Tree_GG_TTb_ij(MomTd,Mass2Td) Result(SqAmp)
      use modProcess
      use modParameters
      use modMyRecurrence
      use modKinematics
