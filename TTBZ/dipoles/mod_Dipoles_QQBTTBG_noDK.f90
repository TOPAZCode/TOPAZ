...
#DEFINE _APPLY_CUTS 0
      ...
      MODULE ModDipoles_QQBTTBG_noDK
      implicit none
      ...
      SUBROUTINE EvalDipoles_QQBTTBG_noDK(Mom,Mass2,yRnd,Wgt,ResultSum)
...
!     color and spin correlated tree process
      ...
      integer,target :: HelList(1:4,1:4)
      logical :: applyPSCut

      HelList(1,1:4)=(/1,0,0,0/)
      HelList(2,1:4)=(/0,1,0,0/)
      HelList(3,1:4)=(/1,0,1,0/)
      HelList(4,1:4)=(/0,1,1,0/)
