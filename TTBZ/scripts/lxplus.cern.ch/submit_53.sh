...
if [ "$RunWhat" == "LOLO" ] || [ "$RunWhat" == "ALL" ] ; then
    ...
    export Process=71 VegasIt0=3 VegasIt1=5 VegasNc0=5000000 VegasNc1=8000000
    echo "Submit $RunWhat for couplings deltaV=$RelDelF1V deltaA=$RelDelF1A"
    bsub -q 1nh -J "${ObsSet}.${RunWhat}.${Process}" -n 1,1 -R "type==SLC6_64" -W $WALLTIME < runTOPAZ.sh

    export Process=72 VegasIt0=3 VegasIt1=5 VegasNc0=5000000 VegasNc1=8000000
    bsub -q 1nh -J "${ObsSet}.${RunWhat}.${Process}" -n 1,1 -R "type==SLC6_64" -W $WALLTIME < runTOPAZ.sh
fi
...
if [ "$RunWhat" == "VI" ] || [ "$RunWhat" == "ALL" ] ; then
    ...
    export VegasSeed=20
    export Process=71 VegasIt0=3 VegasIt1=5 VegasNc0=10000000 VegasNc1=100000
    echo "Submit $RunWhat for couplings deltaV=$RelDelF1V deltaA=$RelDelF1A"
    bsub -q 2nd -J "${ObsSet}.${RunWhat}.${Process}" -n 1,1 -R "type==SLC6_64" -W $WALLTIME < runTOPAZ.sh
    export Process=72 VegasIt0=3 VegasIt1=5 VegasNc0=10000000 VegasNc1=100000
    bsub -q 2nd -J "${ObsSet}.${RunWhat}.${Process}" -n 1,1 -R "type==SLC6_64" -W $WALLTIME < runTOPAZ.sh
...
if [ "$RunWhat" == "DKRE" ] || [ "$RunWhat" == "ALL" ] ; then
    ...
    echo "Submit $RunWhat for couplings deltaV=$RelDelF1V deltaA=$RelDelF1A"
    bsub -q 1nd -J "${ObsSet}.${RunWhat}.${Process}" -n 1,1 -R "type==SLC6_64" -W $WALLTIME < runTOPAZ.sh
    export Process=72 VegasIt0=3 VegasIt1=5 VegasNc0=1000000 VegasNc1=10000000
    bsub -q 1nd -J "${ObsSet}.${RunWhat}.${Process}" -n 1,1 -R "type==SLC6_64" -W $WALLTIME < runTOPAZ.sh
