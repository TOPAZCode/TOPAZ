...
#define InputColorFile "/home/schulze/projects/ttbjets/colors/LO_ttbqqbg_input.frm"
#define OutputFile "/home/schulze/projects/ttbjets/colors/LO_ttbqqbg_output"
*_____________________________________________________________________________________________*
#define setDSTm4 "0"
#define setDST   "4"

#define InterfereDiags1 "{1,2,3,4}";
#define InterfereDiags2 "{1,2,3,4}";
*_____________________________________________________________________________________________*
...
#do TheAmp = `InterfereDiags1'
  #write <`OutputFile'.dat> "ColLO_ttbqqbg[`TheAmp',{`TheCcAmp'}] = (%E); ", [`TheAmp',`TheCcAmp',Col]
#enddo
#enddo
