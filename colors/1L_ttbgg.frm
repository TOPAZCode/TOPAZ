...
#define InputColorFile "/home/schulze/projects/ttbjets/colors/1L_ttbgg_input.frm"
#define OutputFile "/home/schulze/projects/ttbjets/colors/1L_ttbgg_output"
*_____________________________________________________________________________________________*
#define setDSTm4 "0"
#define setDST   "4"

#define InterfereDiags1 "{1,2}";
#define InterfereDiags2 "{10,11,12,13,14,15,16,17,18}";
*_____________________________________________________________________________________________*
...
#do TheCcAmp = `InterfereDiags2'
  #write <`OutputFile'.dat> "Col1L_ttbgg[`TheAmp',{`TheCcAmp'-9}] = (%E); ", [`TheAmp',`TheCcAmp',Col]
#enddo
#enddo
