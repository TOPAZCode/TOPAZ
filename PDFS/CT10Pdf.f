...
C                 Use Polint which allows x to be anywhere w.r.t. the grid
         ...
         Call Polint4F10 (XVpow(0), Fij(1), ss, Fx)
...
C                                                This is the highest x bin:
        ...
        Call Polint4F10 (XVpow(Nx-3), Upd(J1), ss, Fx)
...
C                                       ********************
      ...
      SUBROUTINE POLINT4F10 (XA,YA,X,Y)
