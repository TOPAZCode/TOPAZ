...
C  
C FOR PROCESS : g g -> t t~ a  
C  
C Crossing   1 is g g -> t t~ a  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION GG_TTBA(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,3   ),W(1,5   ),GAU ,TMASS   ,TWIDTH  ,W(1,7   ))    
      ...
      CALL IOVXXX(W(1,4   ),W(1,9   ),W(1,5   ),GAU ,AMP(2   ))            
      CALL IOVXXX(W(1,6   ),W(1,8   ),W(1,5   ),GAU ,AMP(3   ))            
      ...
      CALL IOVXXX(W(1,4   ),W(1,12  ),W(1,5   ),GAU ,AMP(5   ))            
      CALL IOVXXX(W(1,10  ),W(1,11  ),W(1,5   ),GAU ,AMP(6   ))            
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,13  ))      
      CALL FVIXXX(W(1,4   ),W(1,13  ),GG ,TMASS   ,TWIDTH  ,W(1,14  ))     
      CALL IOVXXX(W(1,14  ),W(1,3   ),W(1,5   ),GAU ,AMP(7   ))            
      CALL FVOXXX(W(1,3   ),W(1,13  ),GG ,TMASS   ,TWIDTH  ,W(1,15  ))     
      CALL IOVXXX(W(1,4   ),W(1,15  ),W(1,5   ),GAU ,AMP(8   ))            
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          GG_TTBA =GG_TTBA+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
