...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=T_BEPVEGG(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION T_BEPVEGG(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,1   ),W(1,9   ),W(1,12  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,10  ),W(1,6   ),GG ,TMASS   ,TWIDTH  ,W(1,13  ))     
      CALL IOVXXX(W(1,13  ),W(1,2   ),W(1,7   ),GWF ,AMP(4   ))            
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,8   ),W(1,14  ),W(1,7   ),GWF ,AMP(5   ))            
      CALL FVIXXX(W(1,1   ),W(1,7   ),GWF ,BMASS   ,ZERO    ,W(1,15  ))    
      CALL IOVXXX(W(1,15  ),W(1,11  ),W(1,5   ),GG ,AMP(6   ))             
      CALL IOVXXX(W(1,15  ),W(1,2   ),W(1,12  ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,14  ),W(1,6   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,1   ),W(1,16  ),W(1,7   ),GWF ,AMP(8   ))            
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          T_BEPVEGG =T_BEPVEGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
