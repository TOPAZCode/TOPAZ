...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=T_EPVEBBBB(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION T_EPVEBBBB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,10  ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,6   ),W(1,4   ),W(1,12  ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,5   ),W(1,7   ),GWF ,TMASS   ,TWIDTH  ,W(1,13  ))    
      CALL JIOXXX(W(1,6   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,1   ),W(1,13  ),W(1,14  ),GG ,AMP(4   ))             
      JAMP(   1) = -AMP(   1)-AMP(   2)
      JAMP(   2) = +AMP(   3)+AMP(   4)
      T_EPVEBBBB = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          T_EPVEBBBB =T_EPVEBBBB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
