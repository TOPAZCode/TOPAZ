      SUBROUTINE SGG_BEPVEBBEMVEA(P1,ANS)
C
...
C
C FOR PROCESS : g g -> b e+ ve b~ e- ve~ a
C
C Crossing   1 is g g -> b e+ ve b~ e- ve~ a
      IMPLICIT NONE
C
C CONSTANTS
C
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=GG_BEPVEBBEMVEA(P ,NHEL(1,IHEL),JC(1))
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION GG_BEPVEBBEMVEA(P,NHEL,IC)
C
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C
      ...
      PARAMETER (NGRAPHS=  32,NEIGEN=  2,NEXTERNAL=9)
      INTEGER    NWAVEFUNCS     , NCOLOR
      PARAMETER (NWAVEFUNCS=  52, NCOLOR=   2)
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
C
C ARGUMENTS
...
C ----------
      ...
      CALL FVOXXX(W(1,3   ),W(1,9   ),GAD ,BMASS   ,ZERO    ,W(1,12  ))
      CALL FVOXXX(W(1,12  ),W(1,10  ),GWF ,TMASS   ,TWIDTH  ,W(1,13  ))
      CALL FVIXXX(W(1,6   ),W(1,11  ),GWF ,TMASS   ,TWIDTH  ,W(1,14  ))
      CALL FVOXXX(W(1,13  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,15  ))
      CALL IOVXXX(W(1,14  ),W(1,15  ),W(1,1   ),GG ,AMP(1   ))
      CALL FVIXXX(W(1,4   ),W(1,9   ),GAL ,ZERO    ,ZERO    ,W(1,16  ))
      CALL JIOXXX(W(1,16  ),W(1,5   ),GWF ,WMASS   ,WWIDTH  ,W(1,17  ))
      CALL FVOXXX(W(1,3   ),W(1,17  ),GWF ,TMASS   ,TWIDTH  ,W(1,18  ))
      CALL FVIXXX(W(1,14  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,19  ))
      CALL IOVXXX(W(1,19  ),W(1,18  ),W(1,2   ),GG ,AMP(2   ))
      CALL FVIXXX(W(1,6   ),W(1,9   ),GAD ,BMASS   ,ZERO    ,W(1,20  ))
      CALL FVOXXX(W(1,3   ),W(1,10  ),GWF ,TMASS   ,TWIDTH  ,W(1,21  ))
      CALL FVIXXX(W(1,20  ),W(1,11  ),GWF ,TMASS   ,TWIDTH  ,W(1,22  ))
      CALL FVOXXX(W(1,21  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,23  ))
      CALL IOVXXX(W(1,22  ),W(1,23  ),W(1,1   ),GG ,AMP(3   ))
      CALL FVOXXX(W(1,7   ),W(1,9   ),GAL ,ZERO    ,ZERO    ,W(1,24  ))
      CALL JIOXXX(W(1,8   ),W(1,24  ),GWF ,WMASS   ,WWIDTH  ,W(1,25  ))
      CALL FVOXXX(W(1,23  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,26  ))
      CALL IOVXXX(W(1,6   ),W(1,26  ),W(1,25  ),GWF ,AMP(4   ))
      CALL FVOXXX(W(1,21  ),W(1,9   ),GAU ,TMASS   ,TWIDTH  ,W(1,27  ))
      CALL FVOXXX(W(1,27  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,28  ))
      CALL IOVXXX(W(1,14  ),W(1,28  ),W(1,1   ),GG ,AMP(5   ))
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWA ,WMASS   ,WWIDTH  ,W(1,
     &     29  ))
      CALL FVOXXX(W(1,3   ),W(1,29  ),GWF ,TMASS   ,TWIDTH  ,W(1,30  ))
      CALL FVOXXX(W(1,30  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,31  ))
      CALL IOVXXX(W(1,14  ),W(1,31  ),W(1,1   ),GG ,AMP(6   ))
      CALL HVVXXX(W(1,10  ),W(1,9   ),XWAWM ,XWMASS  ,ZERO    ,W(1,
     &     32  ))
      CALL FSOXXX(W(1,3   ),W(1,32  ),XWPQ ,TMASS   ,TWIDTH  ,W(1,
     &     33  ))
      CALL FVOXXX(W(1,33  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,34  ))
      CALL IOVXXX(W(1,14  ),W(1,34  ),W(1,1   ),GG ,AMP(7   ))
      CALL IOVXXX(W(1,19  ),W(1,23  ),W(1,9   ),GAU ,AMP(8   ))
      CALL FVIXXX(W(1,14  ),W(1,9   ),GAU ,TMASS   ,TWIDTH  ,W(1,35  ))
      CALL IOVXXX(W(1,35  ),W(1,23  ),W(1,1   ),GG ,AMP(9   ))
      CALL JVVXXX(W(1,9   ),W(1,11  ),GWWA ,WMASS   ,WWIDTH  ,W(1,
     &     36  ))
      CALL FVIXXX(W(1,6   ),W(1,36  ),GWF ,TMASS   ,TWIDTH  ,W(1,37  ))
      CALL IOVXXX(W(1,37  ),W(1,23  ),W(1,1   ),GG ,AMP(10  ))
      CALL HVVXXX(W(1,11  ),W(1,9   ),XWAWP ,XWMASS  ,ZERO    ,W(1,
     &     38  ))
      CALL FSIXXX(W(1,6   ),W(1,38  ),XWMQ ,TMASS   ,TWIDTH  ,W(1,
     &     39  ))
      CALL IOVXXX(W(1,39  ),W(1,23  ),W(1,1   ),GG ,AMP(11  ))
      CALL FVOXXX(W(1,13  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,40  ))
      CALL IOVXXX(W(1,14  ),W(1,40  ),W(1,2   ),GG ,AMP(12  ))
      CALL FVIXXX(W(1,14  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,41  ))
      CALL IOVXXX(W(1,41  ),W(1,18  ),W(1,1   ),GG ,AMP(13  ))
      CALL FVOXXX(W(1,21  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,42  ))
      CALL IOVXXX(W(1,22  ),W(1,42  ),W(1,2   ),GG ,AMP(14  ))
      CALL FVOXXX(W(1,42  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,43  ))
      CALL IOVXXX(W(1,6   ),W(1,43  ),W(1,25  ),GWF ,AMP(15  ))
      CALL FVOXXX(W(1,27  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,44  ))
      CALL IOVXXX(W(1,14  ),W(1,44  ),W(1,2   ),GG ,AMP(16  ))
      CALL FVOXXX(W(1,30  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,45  ))
      CALL IOVXXX(W(1,14  ),W(1,45  ),W(1,2   ),GG ,AMP(17  ))
      CALL FVOXXX(W(1,33  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,46  ))
      CALL IOVXXX(W(1,14  ),W(1,46  ),W(1,2   ),GG ,AMP(18  ))
      CALL IOVXXX(W(1,41  ),W(1,42  ),W(1,9   ),GAU ,AMP(19  ))
      CALL IOVXXX(W(1,35  ),W(1,42  ),W(1,2   ),GG ,AMP(20  ))
      CALL IOVXXX(W(1,37  ),W(1,42  ),W(1,2   ),GG ,AMP(21  ))
      CALL IOVXXX(W(1,39  ),W(1,42  ),W(1,2   ),GG ,AMP(22  ))
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,47  ))
      CALL FVOXXX(W(1,13  ),W(1,47  ),GG ,TMASS   ,TWIDTH  ,W(1,48  ))
      CALL IOVXXX(W(1,6   ),W(1,48  ),W(1,11  ),GWF ,AMP(23  ))
      CALL IOVXXX(W(1,14  ),W(1,18  ),W(1,47  ),GG ,AMP(24  ))
      CALL FVOXXX(W(1,21  ),W(1,47  ),GG ,TMASS   ,TWIDTH  ,W(1,49  ))
      CALL IOVXXX(W(1,20  ),W(1,49  ),W(1,11  ),GWF ,AMP(25  ))
      CALL JIOXXX(W(1,6   ),W(1,49  ),GWF ,WMASS   ,WWIDTH  ,W(1,50  ))
      CALL IOVXXX(W(1,8   ),W(1,24  ),W(1,50  ),GWF ,AMP(26  ))
      CALL IOVXXX(W(1,14  ),W(1,27  ),W(1,47  ),GG ,AMP(27  ))
      CALL FVOXXX(W(1,30  ),W(1,47  ),GG ,TMASS   ,TWIDTH  ,W(1,51  ))
      CALL IOVXXX(W(1,6   ),W(1,51  ),W(1,11  ),GWF ,AMP(28  ))
      CALL FVOXXX(W(1,33  ),W(1,47  ),GG ,TMASS   ,TWIDTH  ,W(1,52  ))
      CALL IOVXXX(W(1,6   ),W(1,52  ),W(1,11  ),GWF ,AMP(29  ))
      CALL IOVXXX(W(1,14  ),W(1,49  ),W(1,9   ),GAU ,AMP(30  ))
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,36  ),GWF ,AMP(31  ))
      CALL IOSXXX(W(1,6   ),W(1,49  ),W(1,38  ),XWMQ ,AMP(32  ))
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   3)+AMP(   4)+AMP(   5)
     &             +AMP(   6)+AMP(   7)+AMP(   8)+AMP(   9)+AMP(  10)
     &             +AMP(  11)-AMP(  23)-AMP(  24)-AMP(  25)-AMP(  26)
     &             -AMP(  27)-AMP(  28)-AMP(  29)-AMP(  30)-AMP(  31)
     &             -AMP(  32)
      JAMP(   2) = +AMP(  12)+AMP(  13)+AMP(  14)+AMP(  15)+AMP(  16)
     &             +AMP(  17)+AMP(  18)+AMP(  19)+AMP(  20)+AMP(  21)
     &             +AMP(  22)+AMP(  23)+AMP(  24)+AMP(  25)+AMP(  26)
     &             +AMP(  27)+AMP(  28)+AMP(  29)+AMP(  30)+AMP(  31)
     &             +AMP(  32)
      GG_BEPVEBBEMVEA = 0.D0
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          GG_BEPVEBBEMVEA =GG_BEPVEBBEMVEA+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
