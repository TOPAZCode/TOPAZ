      SUBROUTINE SGG_TTB(P1,ANS)
C ifort -O0 -check all -c gg_ttb.f -I/home/schulze/lib/HELAS-3.0/
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION GG_TTB(P,NHEL,IC)
C
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,4   ),W(1,5   ),W(1,1   ),GG ,AMP(1   ))
      CALL FVOXXX(W(1,3   ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,6   ))
      CALL IOVXXX(W(1,4   ),W(1,6   ),W(1,2   ),GG ,AMP(2   ))
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,7   ))
      CALL IOVXXX(W(1,4   ),W(1,3   ),W(1,7   ),GG ,AMP(3   ))
      JAMP(   1) = -AMP(   1)+AMP(   3)
      JAMP(   2) = -AMP(   2)-AMP(   3)
!       print *, JAMP(   1),JAMP(   2),AMP(   1),AMP(   2),AMP(   3)
      GG_TTB = 0.D0
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          ENDDO
          GG_TTB =GG_TTB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
