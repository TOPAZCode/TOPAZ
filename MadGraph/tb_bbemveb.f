...
C  
C FOR PROCESS : t~ -> b~ e- ve~  
C  
C Crossing   1 is t~ b -> e- ve~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=TB_BBEMVEB(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION TB_BBEMVEB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,2   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,5   ))    
      CALL IOVXXX(W(1,4   ),W(1,3   ),W(1,5   ),GWF ,AMP(1   ))            
      JAMP(   1) = +AMP(   1)
      TB_BBEMVEB = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          TB_BBEMVEB =TB_BBEMVEB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
