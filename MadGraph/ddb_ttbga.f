...
C  
C FOR PROCESS : d d~ -> t t~ g a  
C  
C Crossing   1 is d d~ -> t t~ g a  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=DDB_TTBGA(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION DDB_TTBGA(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,6   ),GAD ,ZERO    ,ZERO    ,W(1,8   ))    
      ...
      CALL FVOXXX(W(1,2   ),W(1,6   ),GAD ,ZERO    ,ZERO    ,W(1,11  ))    
      CALL IOVXXX(W(1,10  ),W(1,11  ),W(1,7   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,3   ),W(1,6   ),GAU ,TMASS   ,TWIDTH  ,W(1,12  ))    
      CALL JIOXXX(W(1,10  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,4   ),W(1,12  ),W(1,13  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,4   ),W(1,6   ),GAU ,TMASS   ,TWIDTH  ,W(1,14  ))    
      CALL IOVXXX(W(1,14  ),W(1,3   ),W(1,13  ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,10  ),W(1,6   ),GAD ,ZERO    ,ZERO    ,W(1,15  ))    
      ...
      CALL FVOXXX(W(1,16  ),W(1,6   ),GAD ,ZERO    ,ZERO    ,W(1,19  ))    
      ...
      CALL IOVXXX(W(1,25  ),W(1,3   ),W(1,6   ),GAU ,AMP(13  ))            
      CALL IOVXXX(W(1,14  ),W(1,20  ),W(1,23  ),GG ,AMP(14  ))             
      CALL IOVXXX(W(1,24  ),W(1,20  ),W(1,6   ),GAU ,AMP(15  ))            
      ...
      CALL IOVXXX(W(1,4   ),W(1,28  ),W(1,6   ),GAU ,AMP(19  ))            
      CALL IOVXXX(W(1,26  ),W(1,27  ),W(1,6   ),GAU ,AMP(20  ))            
     ...
     &             -AMP(  21)-AMP(  22)+AMP(  23)+AMP(  24) 
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          DDB_TTBGA =DDB_TTBGA+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
