...
C  
C FOR PROCESS : g g -> u u~  
C  
C Crossing   1 is g g -> u u~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION GG_UUB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,3   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,5   ))     
      CALL IOVXXX(W(1,4   ),W(1,5   ),W(1,1   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,3   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          GG_UUB =GG_UUB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
