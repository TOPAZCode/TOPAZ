      SUBROUTINE STB_EMVEBBBUUB(P1,ANS)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=TB_EMVEBBBUUB(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION TB_EMVEBBBUUB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          TB_EMVEBBBUUB =TB_EMVEBBBUUB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
