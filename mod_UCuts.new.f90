...
!     alpha_5 = 0d0
      ...
      call resid4Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(1))
!----------------- 2 ---------------------
      alpha_1 = -1d0
!     alpha_5 = 0d0
      ...
      call resid4Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(2))
...
!----------------- 3 ---------------------
      ...
      do k=3,5
            ...
            call resid4Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(k))
...
!             LinSysEq(k,7) = s1(k)*s2(k)**2
            ...
            call resid3Subtr(LoopMom(1:5),ThePrimAmp,CutNum,LinSysEq(k,8))
         enddo
   ...
   !     s2(8) = 0d0
         ...
         call resid3Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res8)
...
!                                 - TripCuts%Coeff(CutNum,3) * s1(8)**2
   ...
   !     s2(9) = 0d0
         ...
         call resid3Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res9)
...
!                                 - TripCuts%Coeff(CutNum,3) * s1(9)**2
   ...
   !     s1(10) = 0d0
         ...
         call resid3Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res10)
...
!                LinSysEq(k,6) = s2(k)**2-s3(k)**2
               ...
               call resid2Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(k))
            enddo
...
!                 LinSysEq(k,6) = s2(k)**2-s3(k)**2
         ...
         call resid2Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(10))
...
! -------- #1
         ...
         call resid2Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(1))
...
! -------- #2
         ...
         call resid2Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(2))
...
! -------- #3
         ...
         call resid2Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(3))
...
! -------- #4
         ...
         call resid2Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(4))
...
! -------- #5
         ...
         call resid2Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(5))
...
! -------- #10
         ...
         call resid2Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(6))
...
!DEC$ ENDIF
       ...
       call resid1Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(1))

       LoopMom(1:4) = - LoopMom(1:4)
       LoopMom(5)   = 0d0
       call resid1(LoopMom(1:5),SingCuts%CutProp(CutNum,1:1),TreeProcs,Res(2))
       call resid1Subtr(LoopMom(1:5),ThePrimAmp,CutNum,Res(2))
