...
!  4_q & 5_g refer to the initial state here


      subroutine EvalDipoles_QBGTTBQBG(p,sum_dip)
...
!-------------- two pure colliner dipoles
      data dip(21,1)/3/ , dip(21,2)/4/, dip(21,3)/5/
      data dip(22,1)/3/ , dip(22,2)/5/, dip(22,3)/4/
      real(dp) :: mass(6)
