...
#DEFINE _APPLY_CUTS 0
      ...
      SUBROUTINE EvalDipoles_QGTTBQ_noDK(Mom,Mass2,yRnd,Wgt,ResultSum)
...
!       pT_tilde = dsqrt( TheDipoles(1)%MomTd(1,3)**2 + TheDipoles(1)%MomTd(2,3)**2 )
!       Bin_PT = WhichBin(Histo_PT,pT_tilde)
!       call intoHisto(Histo_PT,Bin_PT,TheDipoles(1)%DipoleValue)
!       M_tilde = dsqrt( TheDipoles(1)%Mass2Td(3) + TheDipoles(1)%Mass2Td(4) +2d0*TheDipoles(1)%MomTd(0:3,3).dot.TheDipoles(1)%MomTd(0:3,4) )
!       Bin_M = WhichBin(Histo_M,M_tilde)
!       call intoHisto(Histo_M,Bin_M,TheDipoles(1)%DipoleValue)
!       ResultSum = ResultSum + TheDipoles(1)%DipoleValue
...
!
! !     splitting 3: A/Quark_I --> Gluon_I + A/Quark_F
!       Split_A = 2d0*CF/CA*alpha_s4Pi * ( -x )
!       Split_B = 2d0*CF/CA*alpha_s4Pi * ( (1d0/x-1d0)*(4d0*s12/s15/s25) )
!       Split_V(0:3) = Mom(0:3,5) - s15/s12*Mom(0:3,2)
!
! !     color and spin correlated tree process
!       SqAmp = Tree_GG_TTb_152_3(dcmplx(TheDipole%MomTd),TheDipole%Mass2Td,Split_A,Split_B,Split_V)
!
!       TheDipole%DipoleValue = LeadSing * SqAmp
!       return
!       END SUBROUTINE
...
! !     splitting 3: A/Quark_I --> Gluon_I + A/Quark_F
!       Split_A = 2d0*CF/CA*alpha_s4Pi * ( -x )
!       Split_B = 2d0*CF/CA*alpha_s4Pi * ( (1d0/x-1d0)*(4d0*u*(1d0-u)/s35) )
!       Split_V(0:3) = Mom(0:3,5)/u - Mom(0:3,3)/(1d0-u)
!
! !     color and spin correlated tree process
!       SqAmp = Tree_GG_TTb_153_3(dcmplx(TheDipole%MomTd),TheDipole%Mass2Td,Split_A,Split_B,Split_V)
!
!       TheDipole%DipoleValue = LeadSing * SqAmp
!       return
!       END SUBROUTINE
...
! !     splitting 3: A/Quark_I --> Gluon_I + A/Quark_F
!       Split_A = 2d0*CF/CA*alpha_s4Pi * ( -x )
!       Split_B = 2d0*CF/CA*alpha_s4Pi * ( (1d0/x-1d0)*(4d0*u*(1d0-u)/s45) )
!       Split_V(0:3) = Mom(0:3,5)/u - Mom(0:3,4)/(1d0-u)
!
! !     color and spin correlated tree process
!       SqAmp = Tree_GG_TTb_154_3(dcmplx(TheDipole%MomTd),TheDipole%Mass2Td,Split_A,Split_B,Split_V)
!
!       TheDipole%DipoleValue = LeadSing * SqAmp
!       return
!       END SUBROUTINE
...
!
! !     splitting 4: Gluon_I --> A/Quark_I + A/Quark_F
!       Split_A = 2d0*TR/CF*alpha_s4Pi*(1d0-2d0*x+2d0*x**2)
!
! !     color and spin correlated tree process
!       SqAmp = Tree_UUb_TTb_251_4(dcmplx(TheDipole%MomTd),TheDipole%Mass2Td,Split_A,Split_B,Split_V)
!
!       TheDipole%DipoleValue = LeadSing * SqAmp
!       return
!       END SUBROUTINE
...
!
! !     color and spin correlated tree process
!       SqAmp = Tree_UUb_TTb_253_4(dcmplx(TheDipole%MomTd),TheDipole%Mass2Td,Split_A,Split_B,Split_V)
!
!       TheDipole%DipoleValue = LeadSing * SqAmp
!       return
!       END SUBROUTINE
...
!
! !     color and spin correlated tree process
!       SqAmp = Tree_UUb_TTb_254_4(dcmplx(TheDipole%MomTd),TheDipole%Mass2Td,Split_A,Split_B,Split_V)
!
!       TheDipole%DipoleValue = LeadSing * SqAmp
!       return
!       END SUBROUTINE
      ...
      double precision Split_A,Split_B,Split_V(0:3),MomDK(0:3,1:6),MomTmp(0:3),PSWgt2,PSWgt3
...
!       FUNCTION Tree_GG_TTb_153_3(MomTd,Mass2Td,Split_A,Split_B,Split_V) Result(SqAmp)
!       use modProcess
!       use modParameters
!       use modMyRecurrence
!       implicit none
...
!
!
!       FUNCTION Tree_GG_TTb_154_3(MomTd,Mass2Td,Split_A,Split_B,Split_V) Result(SqAmp)
!       use modProcess
!       use modParameters
!       use modMyRecurrence
!       implicit none
...
!      calc currents
      ...
      do col =1,1
      do colP=1,1
        SqAmp = SqAmp + ColCorr(colP,col) * Split_A*(2d0* dconjg(Amp(colP,plus)) *Amp(col,plus) )
      enddo
      enddo
...
!       FUNCTION Tree_UUb_TTb_253_4(MomTd,Mass2Td,Split_A,Split_B,Split_V) Result(SqAmp)
!       use modProcess
!       use modParameters
!       use modMyRecurrence
!       implicit none
...
!
!
!       FUNCTION Tree_UUb_TTb_254_4(MomTd,Mass2Td,Split_A,Split_B,Split_V) Result(SqAmp)
!       use modProcess
!       use modParameters
!       use modMyRecurrence
!       implicit none
