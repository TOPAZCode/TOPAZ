...
C  
C FOR PROCESS : c -> s w+ s s~  
C  
C Crossing   1 is c s~ -> w+ s s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION C_SWPSSB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,6   ))    
      CALL JIOXXX(W(1,1   ),W(1,6   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,7   ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,1   ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,8   ))    
      ...
      CALL FVOXXX(W(1,4   ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,11  ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          C_SWPSSB =C_SWPSSB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
