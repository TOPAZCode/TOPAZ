...
C  
C FOR PROCESS : c -> s w+ u u~  
C  
C Crossing   1 is c s~ -> w+ u u~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION C_SWPUUB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          C_SWPUUB =C_SWPUUB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
