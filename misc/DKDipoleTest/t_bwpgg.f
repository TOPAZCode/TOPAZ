...
C  
C FOR PROCESS : t -> b w+ g g  
C  
C Crossing   1 is t b~ -> w+ g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION T_BWPGG(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,3   ),GWF ,TMASS   ,TWIDTH  ,W(1,6   ))    
      CALL FVOXXX(W(1,6   ),W(1,4   ),GG ,TMASS   ,TWIDTH  ,W(1,7   ))     
      CALL IOVXXX(W(1,1   ),W(1,7   ),W(1,5   ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,1   ),W(1,4   ),GG ,TMASS   ,TWIDTH  ,W(1,8   ))     
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,8   ),W(1,9   ),W(1,3   ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,1   ),W(1,6   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL VVVXXX(W(1,5   ),W(1,4   ),W(1,10  ),G ,AMP(3   ))              
      CALL IOVXXX(W(1,8   ),W(1,6   ),W(1,5   ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,2   ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL FVIXXX(W(1,1   ),W(1,5   ),GG ,TMASS   ,TWIDTH  ,W(1,12  ))     
      CALL IOVXXX(W(1,12  ),W(1,11  ),W(1,3   ),GWF ,AMP(5   ))            
      CALL FVIXXX(W(1,1   ),W(1,3   ),GWF ,BMASS   ,ZERO    ,W(1,13  ))    
      CALL FVIXXX(W(1,13  ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,14  ),W(1,2   ),W(1,5   ),GG ,AMP(6   ))             
      CALL JIOXXX(W(1,13  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL VVVXXX(W(1,5   ),W(1,4   ),W(1,15  ),G ,AMP(7   ))              
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          T_BWPGG =T_BWPGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
